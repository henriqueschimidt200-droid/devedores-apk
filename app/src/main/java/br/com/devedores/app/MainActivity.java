...
public class MainActivity extends Activity {
    ...
    void renderClients(){
        ...
        for(Models.Client c:ds.clients){if(!matches(c))continue;shown++;
            ...
            LinearLayout top=Ui.row(this);
            TextView icon=Ui.avatar(this,c.name);top.addView(icon,new LinearLayout.LayoutParams(Ui.dp(this,44),Ui.dp(this,44)));
            LinearLayout meta=Ui.col(this);meta.setPadding(Ui.dp(this,11),0,0,0);
            meta.addView(Ui.title(this,c.name,16));
            meta.addView(Ui.label(this,(c.phone.isEmpty()?"Sem telefone":c.phone)+"  •  "+c.documents.size()+" arquivo(s)"));
            ...
            LinearLayout right=Ui.col(this);right.setPadding(0,0,0,0);right.addView(Ui.eyebrow(this,"CONTRATOS"));right.addView(Ui.label(this,c.loans.size()+" contrato(s)  •  "+(overdue>0?overdue+" atrasada(s)":"sem atrasos")));info.addView(right,new LinearLayout.LayoutParams(0,Ui.dp(this,55),1));card.addView(info);
